...
export const translations = {
  en: {
    ...
    mailbox: {
      ...
      noSent: 'You have not sent any scrolls yet.',
      toRecipient: 'To: {address}',
    },
    writing: {
      ...
      schedulePlaceholder: 'When should it arrive?',
      dispatch: 'Dispatch',
      preparing: 'The bird prepares...',
      success: 'Your bird {name} has taken flight.',
      addPage: 'Add Page',
      removePage: 'Remove Page',
      confirmRemovePage: 'This page has content. Are you sure you want to remove it?',
      page: 'Page',
    },
    reading: {
    ...
    notes: {
      ...
      subtitle: 'Whispers and thoughts for later scrolls',
      add: 'New Fragment',
      placeholder: 'A fleeting thought...',
      empty: 'No fragments collected yet.',
      delete: 'Discard',
      save: 'Keep',
      color: 'Tint',
    },
    drafts: {
      title: 'Erasers',
      subtitle: 'Unfinished scrolls waiting to be written',
      empty: 'No erasers found.',
      continue: 'Continue',
      discard: 'Discard',
  ...
  es: {
    ...
    mailbox: {
      ...
      noSent: 'Aún no has enviado ningún pergamino.',
      toRecipient: 'Para: {address}',
    },
    writing: {
      ...
      schedulePlaceholder: '¿Cuándo debería llegar?',
      dispatch: 'Despachar',
      preparing: 'El ave se prepara...',
      success: 'Tu ave {name} ha emprendido el vuelo.',
      addPage: 'Añadir Página',
      removePage: 'Eliminar Página',
      confirmRemovePage: 'Esta página tiene contenido. ¿Estás seguro de que quieres eliminarla?',
      page: 'Página',
    },
    reading: {
    ...
    notes: {
      ...
      subtitle: 'Susurros y pensamientos para futuros pergaminos',
      add: 'Nuevo Fragmento',
      placeholder: 'Un pensamiento fugaz...',
      empty: 'Aún no hay fragmentos recolectados.',
      delete: 'Descartar',
      save: 'Guardar',
      color: 'Tinte',
    },
    drafts: {
      title: 'Borradores',
      subtitle: 'Pergaminos inconclusos esperando ser escritos',
      empty: 'No se encontraron borradores.',
      continue: 'Continuar',
      discard: 'Descartar',
  ...
  pt: {
    ...
    mailbox: {
      ...
      noSent: 'Você ainda não enviou nenhum pergaminho.',
      toRecipient: 'Para: {address}',
    },
    writing: {
      ...
      schedule: 'Agendar Entrega',
      schedulePlaceholder: 'Quando deve chegar?',
      dispatch: 'Despachar',
      preparing: 'A ave está se preparando...',
      success: 'Sua ave {name} levantou voo.',
      addPage: 'Adicionar Página',
      removePage: 'Remover Página',
      confirmRemovePage: 'Esta página tem conteúdo. Tem certeza que deseja removê-la?',
      page: 'Página',
    },
    reading: {
    ...
    notes: {
      ...
      subtitle: 'Sussurros e pensamentos para futuros pergaminhos',
      add: 'Novo Fragmento',
      placeholder: 'Um pensamento fugaz...',
      empty: 'Ainda não há fragmentos coletados.',
      delete: 'Descartar',
      save: 'Guardar',
      color: 'Matiz',
    },
    drafts: {
      title: 'Rascunhos',
      subtitle: 'Pergaminhos inacabados esperando para serem escritos',
